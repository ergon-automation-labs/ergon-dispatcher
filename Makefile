...
.PHONY: setup help deps test credo dialyzer coverage check format clean release publish-release publish-release-force setup-hooks setup-db reset-db logs push-and-publish sync-release-version dispatch-test pre-push-cleanup
