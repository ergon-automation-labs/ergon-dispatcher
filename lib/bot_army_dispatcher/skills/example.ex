defmodule BotArmyDispatcher.Skills.Example do
  @moduledoc """
  Example skill for Dispatcher Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_dispatcher.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_dispatcher.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_dispatcher/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_dispatcher.command.example"
    ]
  end
